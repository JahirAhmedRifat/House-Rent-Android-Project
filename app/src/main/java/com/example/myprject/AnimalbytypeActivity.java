...
public class AnimalbytypeActivity extends AppCompatActivity {
    TextView textView;
    EditText searchtext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animalbytype);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AnimalbytypeActivity.this, MainActivity.class));
            }
        });
