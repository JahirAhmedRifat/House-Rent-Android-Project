    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SearchbylocationActivity.this, CustomerActivity.class));
            }
        });
        ...
        searchbytype.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                datalist.clear();
                db.collection("houserent").whereEqualTo("location", searchtext.getText().toString()).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    @Override
